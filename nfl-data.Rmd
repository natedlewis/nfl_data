...
# Load secondary data
weekly_data <- read_csv("./data/weekly_data.csv") %>% select(-full_name, -recent_team, -position -nw_position)
season_data <- read_csv("./data/season_data.csv") %>% select(-full_name, -recent_team, -position -nw_position)
